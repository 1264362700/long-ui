...
const tableData = [
  { id: 1, name: '陈小龙', age: 28, role: '首席架构师', city: '杭州', status: '在职' },
  { id: 2, name: '李梅', age: 24, role: 'UI 设计师', city: '上海', status: '离职' },
  { id: 3, name: '张伟', age: 32, role: '产品经理', city: '北京', status: '在职' },
  { id: 4, name: '王五', age: 26, role: '后端开发', city: '深圳', status: '在职' },
]
</script>
